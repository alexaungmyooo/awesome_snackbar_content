              ...
              onPressed: () {
                const snackBar = SnackBar(
                  ...
                  content: AwesomeSnackbarContent(
                    title: 'On Snap!',
                    message:
                        'This is an example error message that will be shown in the body of snackbar! This is an example error message that will be shown in the body of snackbar!',
